...
module main #(
	...
	// input  wire [7:0]  							  okUH,
	// output wire [1:0]  							  okHU,
	// inout  wire [15:0] 							  okUHU,
	// inout  wire        							  okAA,
	...
	input  wire										  sys_clkp, // fixed 100 MHz oscillator
	input  wire        							  sys_clkn, // fixed 100 MHz oscillator
   //input  wire                              clk1_in, // CY22393 CLKA, f = 100MHz (doesn't exist in 6310)
...
//	assign MISO_A1 = MISO_A1_p;
	...
	wire        okClk;		// 48 MHz clock from Opal Kelly USB interface
	// wire [30:0] okHE;
	// wire [16:0] okEH;
   wire [112:0] okHE;
	wire [64:0] okEH;
   ...
   assign data_stream_8_en_in = 		ep14wirein[7];
	...
	assign ep20wireout = 				{16'h00, num_words_in_FIFO[15:0]};
	assign ep21wireout = 				{16'h00, num_words_in_FIFO[31:16]};
	
	assign ep22wireout = 				{ 31'b0, SPI_running };
		
	assign ep23wireout = 				TTL_in;
	
	assign ep24wireout = 				{ 30'b0, DCM_prog_done, dataclk_locked };

	// Unused; future expansion
	assign ep25wireout = 				32'h0000;
	...
	assign ep3ewireout = 				{16'h000, BOARD_ID};
	assign ep3fwireout = 				{16'h000, BOARD_VERSION};
